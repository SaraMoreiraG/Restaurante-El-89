...
export class CardCarouselComponent implements OnInit {
	cards: {img: string; title: string; description: string; price: string}[] = [
		...
		{
			img: "https://restfood.onlywebcoding.com.ua/images/special-dishes-3.jpg",
			title: "Beef Burger Meal",
			description: "Satisfacción en cada bocado.",
			price: "20€",
		},
		{
			img: "https://restfood.onlywebcoding.com.ua/images/special-dishes-4.jpg",
			title: "Cheese Pizza",
			description: "Doble queso, doble sabor.",
			price: "15€",
		},
		{
			img: "https://restfood.onlywebcoding.com.ua/images/special-dishes-5.png",
			title: "Ensalada César",
			description: "Frescura y sabor en cada hoja.",
			price: "18€",
		},
		{
			img: "https://restfood.onlywebcoding.com.ua/images/special-dishes-2.jpg",
			title: "Pasta",
